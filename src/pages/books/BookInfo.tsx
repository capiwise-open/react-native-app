...
type Route = RouteProp<BookStackParams, "BookInfo">;
...
const BookInfo = () => {
    ...
    const bannerUrl = route.params.data.attributes?.thumb?.data?.attributes?.url ?? (bookList?.find(b => b.id === route.params.data.id)?.attributes.thumb?.data?.attributes?.url);
        ...
        <ScrollView style={{
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={styles.subtitle}>by {route.params.data.attributes?.category}</Text>
                </View>
                {/* rating */}
                <View style={{
                    flexDirection: 'row',
